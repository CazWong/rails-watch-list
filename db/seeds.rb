...
Bookmark.destroy_all && List.destroy_all && Movie.destroy_all if Rails.env.development?
...
Bookmark.create!(comment: "Recommended by", movie: movie1, list: drama)
Bookmark.create!(comment: "Su[erjero movie revisited in 2020", movie: movie2, list: fiction)
Bookmark.create!(comment: "Spielberg's masterly oscar-wining drma", movie: movie1, list: comedy)
Bookmark.create!(comment: "2020 release", movie: movie3, list: comedy)
